...
class MathJaxHTMLSingleExportThread(ExportThread):
    ...
    def _createTableOfContents(self, myHtml):
        ...
        if query is not None:
            elem = html.Element('p')
            elem.text = 'Screen Reader Users: This document has been optimized for use with JAWS 16 and ' \
                        'Internet Explorer. Page numbers have been converted to heading 6.'
            navRoot.append(elem)
