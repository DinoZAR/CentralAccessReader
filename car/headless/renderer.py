...
class HeadlessRendererThread(QThread):
    ...
    a thread, allowing it to be run separately from the GUI.
    '''
    ...
    def run(self):
        ...
        ps = subprocess.Popen([phantomPath, os.path.basename(jsPath), os.path.basename(htmlPath)], stdout=subprocess.PIPE, cwd=os.path.dirname(htmlPath), shell=True)
