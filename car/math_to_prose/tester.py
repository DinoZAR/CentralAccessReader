...
DATABASE_PATH = 'W:\\Nifty Prose Articulator\\workspace2\\another\\car\\math_patterns\\General.txt'

print 'Starting!'

from lxml import etree
 
from car.math_to_prose.pattern_tree import convertDOMToPatternTree
from car.math_to_prose.database import parse, convertToPatternTree
from car.math_to_prose.parser import transform
