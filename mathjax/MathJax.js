    ...
    if (!(window.MathJax && MathJax.Hub)) {
            ...
            BASE.Object = OBJECT({
                ...
                SimpleSUPER: OBJECT({
                    ...
                    wrapper: function () {
                        ...
                        try {
                            var result = fn.original.apply(this, arguments)
                        } catch (err) {
                            delete this.SUPER;
                            throw err
                        }
        ...
        (function (BASENAME) {
            ...
            BASE.Ajax = {
                ...
                config: {
                    root: ""
                }, // URL of root directory to load from
        ...
        MathJax.Message = {
            ...
            File: function (file) {
                ...
                if (file.substr(0, root.length) === root) {
                    file = "[MathJax]" + file.substr(root.length)
                }
        ...
        MathJax.Hub = {
            ...
            Typeset: function (element, callback) {
                ...
                for (var i = 0, m = ec.elements.length; i < m; i++) {
                    if (ec.elements[i]) {
                        queue.Push(
                            ["PreProcess", this, ec.elements[i]], ["Process", this, ec.elements[i]]
                        );
                    }
                }
            ...
            PreProcess: function (element, callback) {
                ...
                for (var i = 0, m = ec.elements.length; i < m; i++) {
                    if (ec.elements[i]) {
                        queue.Push(
                            ["Post", this.signal, ["Begin PreProcess", ec.elements[i]]], (arguments.callee.disabled ? {} : ["Execute", this.preProcessors, ec.elements[i]]), ["Post", this.signal, ["End PreProcess", ec.elements[i]]]
                        );
                    }
                }
                return queue.Push(ec.callback);
        ...
        MathJax.Hub.Startup = {
            ...
            Config: function () {
                ...
                if (user.URL || user.Config) {
                    if (confirm(
                        ...
                        if (user.URL) {
                            this.queue.Push(["Require", MathJax.Ajax, user.URL])
                        }
                        if (user.Config) {
                            this.queue.Push(new Function(user.Config))
                        }
                    } else {
                ...
                this.queue.Push(
                    ["ConfigDelay", this], ["ConfigBlocks", this], [
                        function (THIS) {
            ...
            Cookie: function () {
                return this.queue.Push(
                    ["Post", this.signal, "Begin Cookie"], ["Get", MathJax.HTML.Cookie, "menu", MathJax.Hub.config.menuSettings], [
                        function (config) {
            ...
            Styles: function () {
                return this.queue.Push(
                    ["Post", this.signal, "Begin Styles"], ["loadArray", this, MathJax.Hub.config.styleSheets, "config"], ["Styles", MathJax.Ajax, MathJax.Hub.config.styles], ["Post", this.signal, "End Styles"]
                );
            },
            //
            ...
            Jax: function () {
                ...
                var queue = MathJax.Callback.Queue();
                return queue.Push(
                    ["Post", this.signal, "Begin Jax"], ["loadArray", this, config.jax, "jax", "config.js"], ["Post", this.signal, "End Jax"]
                );
            },
            //
            //  Load the extensions
            ...
            Extensions: function () {
                var queue = MathJax.Callback.Queue();
                return queue.Push(
                    ["Post", this.signal, "Begin Extensions"], ["loadArray", this, MathJax.Hub.config.extensions, "extensions"], ["Post", this.signal, "End Extensions"]
                );
            },
                    ...
                    setTimeout(
                        function () {
                            MathJax.Callback.Queue(
                                ["Require", MathJax.Ajax, "[MathJax]/extensions/MathMenu.js", {}], ["loadDomain", MathJax.Localization, "MathMenu"]
                            )
                        }, 1000
                    );
                } else {
            ...
            Typeset: function (element, callback) {
                ...
                return this.queue.Push(
                    ["Post", this.signal, "Begin Typeset"], ["Typeset", MathJax.Hub, element, callback], ["Post", this.signal, "End Typeset"]
                );
            },
                ...
                loadComplete: function (file) {
                    if (file === "config.js") {
                        ...
                        queue.Push(
                            ...
                            ["Post", HUB.Startup.signal, this.id + " Jax Config"], ["Config", this], ["Post", HUB.Startup.signal, this.id + " Jax Require"],
                            ...
                            [
                                ...
                                this.config || {},
                                this.id
                            ], ["Post", HUB.Startup.signal, this.id + " Jax Startup"], ["Startup", this], ["Post", HUB.Startup.signal, this.id + " Jax Ready"]
                        );
        ...
        (function (BASENAME) {
            ...
            HUB.Browser.Select({
                ...
                MSIE: function (browser) {
                    ...
                    try {
                        ...
                        browser.hasMathPlayer = MathPlayer = true
                    } catch (err) {}
                    try {
            ...
            HUB.queue.Push(
                ["Post", STARTUP.signal, "Begin"], ["Config", STARTUP], ["Cookie", STARTUP], ["Styles", STARTUP], ["Message", STARTUP],
                function () {
                ...
                ["Typeset", STARTUP], ["Hash", STARTUP], ["Post", STARTUP.signal, "End"]
            );
