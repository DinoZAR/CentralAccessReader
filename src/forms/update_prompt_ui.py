...
class Ui_UpdatePromptDialog(object):
    def setupUi(self, UpdatePromptDialog):
        ...
        UpdatePromptDialog.resize(355, 177)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, UpdatePromptDialog):
        ...
        self.label_3.setText(_translate("UpdatePromptDialog", "Would you like to update the program? The Central Access Reader must close in order to run installer.", None))
