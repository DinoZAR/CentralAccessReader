...
class Ui_ColorSettings(object):
    def setupUi(self, ColorSettings):
        ...
        self.label_2 = QtGui.QLabel(ColorSettings)
        ...
        self.followInsideParagraphCheckBox = QtGui.QCheckBox(ColorSettings)
        ...
        self.themeComboBox = QtGui.QComboBox(ColorSettings)
        self.themeComboBox.setObjectName(_fromUtf8("themeComboBox"))
        self.gridLayout_3.addWidget(self.themeComboBox, 3, 2, 1, 1)
        self.line_2 = QtGui.QFrame(ColorSettings)
        ...
        ColorSettings.setTabOrder(self.highlighterLineTextButton, self.restoreButton)
